...
class odoosv_purchase_report_pdf(models.AbstractModel):
    _name = 'reportesv_sucursal.odoosv_purchase_report_pdf'
    _auto = False
...
class odoosv_taxpayer_report_pdf(models.AbstractModel):
    _name = 'reportesv_sucursal.odoosv_taxpayer_report_pdf'
    _auto = False
...
class odoosv_consumer_report_pdf(models.AbstractModel):
    _name = 'reportesv_sucursal.odoosv_consumer_report_pdf'
    _auto = False
...
class odoosv_ticket_report_pdf(models.AbstractModel):
    _name = 'reportesv_sucursal.odoosv_ticket_report_pdf'
    _auto = False
